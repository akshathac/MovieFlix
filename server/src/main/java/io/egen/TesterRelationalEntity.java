...
"
        ...
        artist.setActors(jsonobj.getString("actors"));
        artist.setAwards(jsonobj.getString("awards"));
        artist.setDirector(jsonobj.getString("director"));
        artist.setWriters(jsonobj.getString("writers"));
        
        Calender calender = new Calender();
        calender.setReleased(jsonobj.getString("released"));
        calender.setRuntime(jsonobj.getString("runtime"));
        calender.setYear(jsonobj.getString("year"));
        
        MovieGenre genre = new MovieGenre();
        genre.setType(jsonobj.getString("type"))
        
        MovieImdb imdb = new MovieImdb();
        imdb.setImdbId(jsonobj.getString("imdbId"));
        imdb.setImdbRating(jsonobj.getString("imdbRating"));
        imdb.setImdbVotes(jsonobj.getString("imdbVotes"));
        imdb.setMetascore(jsonobj.getString("metascore"));
        imdb.setRated(jsonobj.getString("rated");
        
        MovieType movieType = new MovieType();
        movieType.setType(jsonobj.getString("type"));
        ...
        String calenderID = calender.getId();
        movie.setCalenderID(calenderID);
        
        entityManager.persist(genre);
        movieGenreId = genre.getId();
        movie.setMovieGenreId(movieGenreId);
        
        entityManager.persist(imdb);
        String movieImdbId = imdb.getId();
        movie.setMovieImdbId(movieImdbId);
        
        entityManager.persist(movieType);
        String movieTypeID = movieType.getId();
        movie.setMovieType(movieTypeID);
